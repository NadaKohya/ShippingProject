        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PremssionName = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    StaticWeight = table.Column<int>(type: "int", nullable: false),
                    StaticCost = table.Column<int>(type: "int", nullable: false),
                    CostIncrease = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                name: "Premissions_Roles_Entities",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Premissions_Roles_Entities", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Premissions_Roles_Entities_AspNetRoles_MainRoleId",
                        column: x => x.MainRoleId,
                        principalTable: "AspNetRoles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Premissions_Roles_Entities_Entities_EntityId",
                        column: x => x.EntityId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_Orders_Shippings_ShipId",
                        column: x => x.ShipId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Premissions_Roles_Entities_EntityId",
                table: "Premissions_Roles_Entities",
                column: "EntityId");

            migrationBuilder.CreateIndex(
                name: "IX_Premissions_Roles_Entities_MainRoleId",
                table: "Premissions_Roles_Entities",
                column: "MainRoleId");
